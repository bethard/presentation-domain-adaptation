...
Natural language processing and machine learning, e.g.,:
\begin{itemize}
\item Modeling the language of time and timelines
\begin{itemize}
\item E.g., \textit{three days ago} $\Rightarrow$ \texttt{2022-06-17}
\end{itemize}
\item Normalizing text to medical and geospatial ontologies
\begin{itemize}
\item E.g., \textit{Nogales} $\Rightarrow$ \raisebox{-.5\height}{\includegraphics[width=0.5\textwidth]{nogales.png}}
\end{itemize}
\item Information extraction models for clinical applications
\begin{itemize}
\item E.g., 
\end{itemize}
\end{itemize}
