...
\node[label={Learned Model}, inner sep=0pt] (model) at (6, 1.4) {\includegraphics[scale=0.8]{Hey_Machine_Learning_Logo.png}};
...
\node[label=below:{Fine-tuned Model}, inner sep=0pt] (ft-model) at (6, -1.4) {\includegraphics[scale=0.8]{Hey_Machine_Learning_Logo.png}};
